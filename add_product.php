            ...
            <form action="assets/php/add_product.php" method="post" enctype="multipart/form-data">
                <div class="row my-4" style="padding: 50px">
                    <div class="mb-3 col-lg-12">
                        ...
                        <input type="text" name="p_detail"  required class="form-control">
                    </div>
                    <div class="mb-3 col-lg-6">
                        <label for="p_price" class="form-label">ราคา</label>
                        <input type="text" name="p_price"  required class="form-control">
                    </div>
                    <div class="mb-3 col-lg-6">
                        <label for="stock_in" class="form-label">จำนวนในคลังสินค้า</label>
                        <input type="text" name="stock_in" required class="form-control">
                    </div>

                    <div class="mb-3 col-lg-6">
                        
                        <div class="form-group">
                            <label for="exampleFormControlSelect1">เลือกประเภท</label>
                    ...
                    <div class="mb-3 col-lg-6">
                        <label for="filUpload" class="form-label">รูปภาพ</label>
