                    ...
                    <div class="mb-3 col-lg-12">
                        <div class="round-container">
                            <div class="round-header">
                                เพิ่มสต็อกสินค้าของรายการรหัส <?php echo $_GET['p_id'] ?>
                            </div>
                            <div class="round-content">
                                <form action="assets/php/stock_out.php" method="post">
                                    <div class="row">
                                        <?php
                                        ...
                                        // LOAD STOCK IN
                                        $ssql = "select stock_out from stock_in where p_id = '".$_GET['p_id']."'";
                                        $sload = $con->query($ssql);
                                        if($rs = $sload->fetch_assoc()):
                                            ?>
                                            <div class="mb-3 col-lg-12">
                                                <label class="form-label">จำนวนสินค้าในสต็อกปัจจุบัน</label>
                                                <input type="text" class="form-control" readonly value="<?php echo $rs['stock_out'] ?>">
                                            </div>
                                            <div class="mb-3 col-lg-8">
                                                <label class="form-label">กรุณาใส่ตัวเลขเพื่อเพิ่มสต็อกสินค้า</label>
...
<script type="text/javascript">
    function changeFunc(){
        ...
        if(value != null){
            location.href = "add_stock.php?p_id="+value+"";
        }
    }
</script>
<script>
