            ...
            <div class="row">
                <div class="mb-3 col-lg-12">
                    <table class="table table-hover">
                        ...
                        <?php
                        // LOAD MEMBER DATA
                        $sql = "select member_id,fname,lname from member ";
                        $load = $con->query($sql);
                        ...
                        ?>
                            <tr align="center">
                                ...
                                <td><a href="edit_user.php?m_id=<?php echo $data['member_id'] ?>" class="btn btn-primary">ดู/แก้ไข</a></td>
                                <td><button onclick="return con(<?php echo $data['member_id'] ?>);" class="btn btn-danger">ลบ</button></td>
                            </tr>
                        <?php
                        endwhile;
                        ?>
...
<script type="text/javascript">
    function con(x){
        if(window.confirm("คุณต้องการลบใช่หรือไม่")){
            location.href = "assets/php/del_user.php?m_id="+x+"";
        }
    }
</script>
<script>
